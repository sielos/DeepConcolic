...
#
#   return (x_train, y_train), (x_test, y_test), img_shape, 'image', ['1', '0']
#
# datasets.register_dataset('simple', load_simple_data)
...
datasets.register_dataset ('mnist', load_mnist_data)